...
import com.nxp.nxpwalletconndev.adapters.MyDevicesAdapter;
...
public class MyDevicesActivity extends BaseActivity implements OnBluetoothConnectListener {
	...
	private void showDevicesInfo() {
		...
		mList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
				if(MyPreferences.isCardOperationOngoing(MyDevicesActivity.this) == false) {
					...
					Toast.makeText(MyDevicesActivity.this, "You cannot close connection while an operation is ongoing", Toast.LENGTH_LONG).show();
			}
		});
	...
	public void onConnect(final boolean connected) {
		...
		// Show connected device info
		MyDevicesActivity.this.runOnUiThread(new Runnable() {
	        @Override
	        public void run() {
				showDevicesInfo();
